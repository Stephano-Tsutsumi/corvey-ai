...
const Features = () => {
  const features = [
    ...
    },
    {
      ...
      description: "Upload class videos to capture your teacher; communication style and create an AI version to help with homework questions outside the classroom."
    },
    {
      icon: Layout,
